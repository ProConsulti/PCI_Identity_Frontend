...
export const RegistrationWrapper: React.FC<Props> = ({ children }) => {
    ...
    return (
        <React.Fragment>
            {/* Loading State */}
            <SetupOverlay isLoading={isLoading} />
            {/* Success State */}
            <SuccessOverlay isOpen={isSuccess} onClose={handleCloseSuccess} />
            <div className={`min-h-[90vh] bg-[#F8FAFC] transition-all duration-300`}>
