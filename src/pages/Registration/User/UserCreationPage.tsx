...
import type { UserCreateRequest } from '../../../types/api.types';
...
export const UserCreationPage = () => {
    ...
    const { companyID, userEmail } = useAppSelector((state: any) => state.registration);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccess(true);
            // Navigate to login or dashboard after brief success message
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
            <main className="flex py-12 px-4 sm:px-6 lg:px-8 flex-grow">
